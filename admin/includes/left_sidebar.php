<div class="left-side-bar">
		<div class="menu-block customscroll mt-5 py-5">
				...
				<ul id="accordion-menu">
					...
					<li>
						<a href="department.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Departments</span>
						</a>
					</li>
					<li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="New_employee.php">Add Employee</a></li>
